...
"[project]/Backend/newsletter/schema.ts [app-route] (ecmascript)", ((__turbopack_context__) => {
"use strict";
...
"[project]/Backend/newsletter/unsubscribe.ts [app-route] (ecmascript)", ((__turbopack_context__) => {
"use strict";
...
async function unsubscribeByToken(token) {
    ...
    const { data: subscriber, error: selectError } = await supabase.from("newsletter_subscribers").select("id, is_subscribed").eq("unsubscribe_token", token).maybeSingle();
...
"[project]/Backend/newsletter/supabase.ts [app-route] (ecmascript)", ((__turbopack_context__) => {
"use strict";
...
var __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f40$supabase$2f$supabase$2d$js$2f$dist$2f$index$2e$mjs__$5b$app$2d$route$5d$__$28$ecmascript$29$__$3c$locals$3e$__ = __turbopack_context__.i("[project]/node_modules/@supabase/supabase-js/dist/index.mjs [app-route] (ecmascript) <locals>");
var __TURBOPACK__imported__module__$5b$project$5d2f$Backend$2f$shared$2f$env$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__ = __turbopack_context__.i("[project]/Backend/shared/env.ts [app-route] (ecmascript)");
var __TURBOPACK__imported__module__$5b$project$5d2f$Backend$2f$newsletter$2f$unsubscribe$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__ = __turbopack_context__.i("[project]/Backend/newsletter/unsubscribe.ts [app-route] (ecmascript)");
;
;
;
function getServiceClient() {
...
async function upsertNewsletterSubscriber(data) {
    const supabase = getServiceClient();
    const now = new Date().toISOString();
    const { data: existing, error: selectError } = await supabase.from("newsletter_subscribers").select("id, is_subscribed, unsubscribe_token").eq("email_norm", data.emailNorm).maybeSingle();
    if (selectError) throw new Error(`Supabase select failed: ${selectError.message}`);
    if (existing) {
        ...
        const token = existing.unsubscribe_token ?? (0, __TURBOPACK__imported__module__$5b$project$5d2f$Backend$2f$newsletter$2f$unsubscribe$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["generateUnsubscribeToken"])();
        const { data: updated, error: updateError } = await supabase.from("newsletter_subscribers").update({
            is_subscribed: true,
        ...
        }).eq("id", existing.id).select("email").single();
        if (updateError) throw new Error(`Supabase update failed: ${updateError.message}`);
        return {
            status: "resubscribed",
            email: updated.email,
    ...
    const token = (0, __TURBOPACK__imported__module__$5b$project$5d2f$Backend$2f$newsletter$2f$unsubscribe$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["generateUnsubscribeToken"])();
    const { data: inserted, error: insertError } = await supabase.from("newsletter_subscribers").insert({
        email: data.email,
...
async function getUnsubscribeToken(emailNorm) {
    const supabase = getServiceClient();
    const { data, error } = await supabase.from("newsletter_subscribers").select("unsubscribe_token").eq("email_norm", emailNorm).maybeSingle();
...
"[project]/Backend/newsletter/checklists.ts [app-route] (ecmascript)", ((__turbopack_context__) => {
"use strict";
...
function getChecklistUrl(locale) {
    const base = ("TURBOPACK compile-time value", "http://www.moldcheck.pt") ?? "https://www.moldcheck.pt";
...
function getUnsubscribeUrl(locale, token) {
    const base = ("TURBOPACK compile-time value", "http://www.moldcheck.pt") ?? "https://www.moldcheck.pt";
    return `${base}${UNSUBSCRIBE_PATHS[locale]}?token=${encodeURIComponent(token)}`;
}
}),
"[project]/Backend/newsletter/email.ts [app-route] (ecmascript)", ((__turbopack_context__) => {
"use strict";
...
var __TURBOPACK__imported__module__$5b$project$5d2f$Backend$2f$newsletter$2f$checklists$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__ = __turbopack_context__.i("[project]/Backend/newsletter/checklists.ts [app-route] (ecmascript)");
;
;
;
;
...
function buildHtml(copy, checklistUrl, calculatorUrl, unsubscribeUrl, siteBase) {
    const unsubscribeSection = unsubscribeUrl ? `<p style="margin:8px 0 0;font-size:11px;color:#9ab5b4;">
        <a href="${unsubscribeUrl}" style="color:#9ab5b4;text-decoration:underline;">${(0, __TURBOPACK__imported__module__$5b$project$5d2f$Backend$2f$shared$2f$utils$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["esc"])(copy.unsubscribeText)}</a>
      </p>` : "";
    return `<!DOCTYPE html>
<html lang="en">
    ...
    <tr><td align="center">
      <table width="100%" cellpadding="0" cellspacing="0" style="max-width:560px;background:#ffffff;border:1px solid #d8e8e7;border-radius:6px;overflow:hidden;">
        ...
        <tr><td style="padding:32px;">
          <p style="margin:0 0 16px;font-size:15px;line-height:1.7;color:#0f1c1b;">${(0, __TURBOPACK__imported__module__$5b$project$5d2f$Backend$2f$shared$2f$utils$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["esc"])(copy.greeting)}</p>
          <p style="margin:0 0 20px;font-size:15px;line-height:1.7;color:#2e3f3e;">${(0, __TURBOPACK__imported__module__$5b$project$5d2f$Backend$2f$shared$2f$utils$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["esc"])(copy.intro)}</p>
          <table cellpadding="0" cellspacing="0" style="margin-bottom:28px;">
            <tr><td style="background:#2a7a75;border-radius:5px;">
              <a href="${checklistUrl}" style="display:inline-block;padding:12px 24px;font-size:14px;font-weight:700;color:#ffffff;text-decoration:none;letter-spacing:0.02em;">${(0, __TURBOPACK__imported__module__$5b$project$5d2f$Backend$2f$shared$2f$utils$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["esc"])(copy.checklistCta)}</a>
            </td></tr>
          </table>
          <p style="margin:0 0 8px;font-size:14px;color:#2e3f3e;">${(0, __TURBOPACK__imported__module__$5b$project$5d2f$Backend$2f$shared$2f$utils$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["esc"])(copy.calculatorLabel)}</p>
          <p style="margin:0 0 28px;">
            <a href="${calculatorUrl}" style="font-size:14px;color:#2a7a75;font-weight:600;">${(0, __TURBOPACK__imported__module__$5b$project$5d2f$Backend$2f$shared$2f$utils$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["esc"])(copy.calculatorCta)}</a>
          </p>
          <p style="margin:0;font-size:12px;line-height:1.65;color:#6b8a89;">${(0, __TURBOPACK__imported__module__$5b$project$5d2f$Backend$2f$shared$2f$utils$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["esc"])(copy.closing)}</p>
        </td></tr>
        <tr><td style="background:#f7fafa;border-top:1px solid #d8e8e7;padding:16px 32px;">
          <p style="margin:0;font-size:11px;color:#9ab5b4;">${(0, __TURBOPACK__imported__module__$5b$project$5d2f$Backend$2f$shared$2f$utils$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["esc"])(copy.footer)}</p>
          ${unsubscribeSection}
        </td></tr>
      </table>
    </td></tr>
...
async function sendChecklistEmail(email, locale, unsubscribeToken = null) {
    const resend = getResend();
    const from = process.env.CONTACT_FROM_EMAIL ?? "MoldCheck <no-reply@moldcheck.pt>";
    const copy = COPY[locale];
    const siteBase = ("TURBOPACK compile-time value", "http://www.moldcheck.pt") ?? "https://www.moldcheck.pt";
    const unsubscribeUrl = unsubscribeToken ? (0, __TURBOPACK__imported__module__$5b$project$5d2f$Backend$2f$newsletter$2f$checklists$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["getUnsubscribeUrl"])(locale, unsubscribeToken) : null;
    const { error } = await resend.emails.send({
        from,
        to: email,
        subject: copy.subject,
        html: buildHtml(copy, (0, __TURBOPACK__imported__module__$5b$project$5d2f$Backend$2f$newsletter$2f$checklists$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["getChecklistUrl"])(locale), (0, __TURBOPACK__imported__module__$5b$project$5d2f$Backend$2f$newsletter$2f$checklists$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["getCalculatorUrl"])(locale), unsubscribeUrl, siteBase)
    });
    if (error) throw new Error(`Resend error: ${JSON.stringify(error)}`);
}
}),
"[project]/Backend/newsletter/nurture-supabase.ts [app-route] (ecmascript)", ((__turbopack_context__) => {
"use strict";
...
;
function db() {
    return (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f40$supabase$2f$supabase$2d$js$2f$dist$2f$index$2e$mjs__$5b$app$2d$route$5d$__$28$ecmascript$29$__$3c$locals$3e$__["createClient"])((0, __TURBOPACK__imported__module__$5b$project$5d2f$Backend$2f$shared$2f$env$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["requireEnv"])("NEXT_PUBLIC_SUPABASE_URL"), (0, __TURBOPACK__imported__module__$5b$project$5d2f$Backend$2f$shared$2f$env$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["requireEnv"])("SUPABASE_SERVICE_ROLE_KEY"), {
        auth: {
            persistSession: false
        }
    });
...
async function getDueSubscribers() {
    const { data, error } = await db().from("newsletter_subscribers").select("id, email, locale_preference, nurture_step, unsubscribe_token").eq("is_subscribed", true).eq("nurture_status", "active").eq("inspection_booked", false).lte("nurture_next_send_at", new Date().toISOString()).not("nurture_next_send_at", "is", null).not("unsubscribe_token", "is", null) // require token for one-click unsubscribe
    .lt("nurture_step", 6);
    if (error) throw new Error(`getDueSubscribers: ${error.message}`);
    return data ?? [];
}
async function advanceNurtureStep(id, nextStep, nextSendAt) {
    const now = new Date().toISOString();
...
async function initNurture(emailNorm) {
    const now = new Date();
    ...
    }).eq("email_norm", emailNorm).eq("nurture_step", 0); // only if not already started
    if (error) throw new Error(`initNurture: ${error.message}`);
}
async function logNurtureSend(opts) {
    const { error } = await db().from("newsletter_nurture_log").insert({
...
async function backfillMissingTokens() {
    ...
    const { data, error } = await db().from("newsletter_subscribers").select("id").eq("is_subscribed", true).is("unsubscribe_token", null);
...
"[project]/Backend/newsletter/nurture.ts [app-route] (ecmascript)", ((__turbopack_context__) => {
"use strict";
...
const SITE = ()=>("TURBOPACK compile-time value", "http://www.moldcheck.pt") ?? "https://www.moldcheck.pt";
const ARTICLE_SLUGS = {
    bleach: {
...
const NURTURE_DELAYS_DAYS = [
    ...
    7,
    7
]; // index = step 1..6, step 1 is immediate
// ── HTML template ─────────────────────────────────────────────────────────────
function tpl(opts) {
    const cta = opts.ctaLabel && opts.ctaHref ? `<table cellpadding="0" cellspacing="0" style="margin:24px 0;">
        <tr><td style="background:#2a7a75;border-radius:5px;">
          <a href="${opts.ctaHref}" style="display:inline-block;padding:12px 24px;font-size:14px;font-weight:700;color:#ffffff;text-decoration:none;letter-spacing:0.02em;">${(0, __TURBOPACK__imported__module__$5b$project$5d2f$Backend$2f$shared$2f$utils$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["esc"])(opts.ctaLabel)}</a>
        </td></tr>
      </table>` : "";
    return `<!DOCTYPE html>
<html lang="en">
<head><meta charset="UTF-8"><meta name="viewport" content="width=device-width,initial-scale=1">
<title>${(0, __TURBOPACK__imported__module__$5b$project$5d2f$Backend$2f$shared$2f$utils$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["esc"])(opts.previewText)}</title></head>
<body style="margin:0;padding:0;background:#f7fafa;font-family:ui-sans-serif,-apple-system,BlinkMacSystemFont,'Segoe UI',sans-serif;">
<div style="display:none;max-height:0;overflow:hidden;mso-hide:all;">${(0, __TURBOPACK__imported__module__$5b$project$5d2f$Backend$2f$shared$2f$utils$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["esc"])(opts.previewText)}</div>
<table width="100%" cellpadding="0" cellspacing="0" style="background:#f7fafa;padding:40px 16px;">
  <tr><td align="center">
    <table width="100%" cellpadding="0" cellspacing="0" style="max-width:580px;background:#ffffff;border:1px solid #d8e8e7;border-radius:6px;overflow:hidden;">
      ...
      <tr><td style="background:#f7fafa;border-top:1px solid #d8e8e7;padding:14px 32px;">
        <p style="margin:0;font-size:11px;color:#9ab5b4;line-height:1.6;">
          ${(0, __TURBOPACK__imported__module__$5b$project$5d2f$Backend$2f$shared$2f$utils$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["esc"])(opts.footerLine)}<br>
          <a href="${opts.unsubscribeUrl}" style="color:#9ab5b4;text-decoration:underline;">${(0, __TURBOPACK__imported__module__$5b$project$5d2f$Backend$2f$shared$2f$utils$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["esc"])(opts.unsubscribeLabel)}</a>
          &nbsp;·&nbsp;
          <a href="${opts.privacyUrl}" style="color:#9ab5b4;text-decoration:underline;">${(0, __TURBOPACK__imported__module__$5b$project$5d2f$Backend$2f$shared$2f$utils$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["esc"])(opts.privacyLabel)}</a>
          &nbsp;·&nbsp;moldcheck.pt
        </p>
      </td></tr>
    </table>
...
function p(text) {
    return `<p style="margin:0 0 14px;font-size:15px;line-height:1.75;color:#1a2e2d;">${(0, __TURBOPACK__imported__module__$5b$project$5d2f$Backend$2f$shared$2f$utils$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["esc"])(text)}</p>`;
}
function h(text) {
    return `<p style="margin:20px 0 8px;font-size:13px;font-weight:700;letter-spacing:0.06em;text-transform:uppercase;color:#2a7a75;">${(0, __TURBOPACK__imported__module__$5b$project$5d2f$Backend$2f$shared$2f$utils$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["esc"])(text)}</p>`;
}
function ul(items) {
    return `<ul style="margin:0 0 14px;padding-left:20px;">${items.map((i)=>`<li style="font-size:15px;line-height:1.75;color:#1a2e2d;margin-bottom:4px;">${(0, __TURBOPACK__imported__module__$5b$project$5d2f$Backend$2f$shared$2f$utils$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["esc"])(i)}</li>`).join("")}</ul>`;
}
function link(label, href) {
    return `<a href="${href}" style="color:#2a7a75;font-weight:600;text-decoration:none;">${(0, __TURBOPACK__imported__module__$5b$project$5d2f$Backend$2f$shared$2f$utils$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["esc"])(label)}</a>`;
}
// ── EN sequence ───────────────────────────────────────────────────────────────
const EN = [
    {
    ...
    },
    {
        ...
        html: ({ unsubscribeUrl, privacyUrl: pUrl, articleUrl: aUrl })=>tpl({
                ...
                body: [
                    ...
                    ul([
                        "Persistent dry cough, worse at night or in the morning",
                        "Nasal congestion without obvious seasonal pattern",
                        "Fatigue that doesn't improve with rest",
                        "Frequent headaches on waking",
                        "Eyes that itch or water indoors"
                    ]),
    ...
    },
    {
        ...
        html: ({ unsubscribeUrl, privacyUrl: pUrl, articleUrl: aUrl })=>tpl({
                ...
                body: [
                    ...
                    ul([
                        "Tosse seca persistente, pior à noite ou de manhã",
                        "Congestão nasal sem padrão sazonal óbvio",
                        "Fadiga que não melhora com o descanso",
                        "Dores de cabeça frequentes ao acordar",
                        "Olhos que coçam ou lacrimejam em casa"
                    ]),
    ...
    },
    {
        ...
        html: ({ unsubscribeUrl, privacyUrl: pUrl, articleUrl: aUrl })=>tpl({
                ...
                body: [
                    ...
                    ul([
                        "Toux sèche persistante, pire la nuit ou le matin",
                        "Congestion nasale sans schéma saisonnier évident",
                        "Fatigue qui ne s'améliore pas avec le repos",
                        "Maux de tête fréquents au réveil",
                        "Yeux qui démangent ou larmoient à l'intérieur"
                    ]),
    ...
    },
    {
        ...
        html: ({ unsubscribeUrl, privacyUrl: pUrl, articleUrl: aUrl })=>tpl({
                ...
                body: [
                    ...
                    ul([
                        "Anhaltender trockener Husten, schlimmer nachts oder morgens",
                        "Nasenverstopfung ohne offensichtliches saisonales Muster",
                        "Erschöpfung, die sich mit Ruhe nicht bessert",
                        "Häufige Kopfschmerzen beim Aufwachen",
                        "Augen, die in Innenräumen jucken oder tränen"
                    ]),
    ...
    },
    {
        ...
        html: ({ unsubscribeUrl, privacyUrl: pUrl, articleUrl: aUrl })=>tpl({
                ...
                body: [
                    ...
                    ul([
                        "Aanhoudende droge hoest, erger 's nachts of 's ochtends",
                        "Neusverstopping zonder duidelijk seizoenspatroon",
                        "Vermoeidheid die niet verbetert met rust",
                        "Frequente hoofdpijn bij het wakker worden",
                        "Ogen die jeuken of tranen binnenshuis"
                    ]),
...
async function sendNurtureEmail(opts) {
    ...
    const siteBase = ("TURBOPACK compile-time value", "http://www.moldcheck.pt") ?? "https://www.moldcheck.pt";
    const unsubUrl = unsubscribeToken ? (0, __TURBOPACK__imported__module__$5b$project$5d2f$Backend$2f$newsletter$2f$checklists$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["getUnsubscribeUrl"])(locale, unsubscribeToken) : `${siteBase}/${locale}/newsletter/unsubscribe`;
    const pUrl = privacyUrl(locale);
    // Build context-specific URLs
    const articleUrlForStep = {
    ...
    const html = emailDef.html({
        checklistUrl: (0, __TURBOPACK__imported__module__$5b$project$5d2f$Backend$2f$newsletter$2f$checklists$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["getChecklistUrl"])(locale),
...
// ── Delay helpers ─────────────────────────────────────────────────────────────
/** Days to add after sending step N to schedule step N+1 */ const STEP_DELAYS = {
    1: 3,
    2: 5,
    3: 5,
    4: 7,
...
function nextSendDate(currentStep) {
...
"[project]/Backend/newsletter/service.ts [app-route] (ecmascript) <locals>", ((__turbopack_context__) => {
"use strict";
...
var __TURBOPACK__imported__module__$5b$project$5d2f$Backend$2f$newsletter$2f$schema$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__ = __turbopack_context__.i("[project]/Backend/newsletter/schema.ts [app-route] (ecmascript)");
var __TURBOPACK__imported__module__$5b$project$5d2f$Backend$2f$newsletter$2f$supabase$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__ = __turbopack_context__.i("[project]/Backend/newsletter/supabase.ts [app-route] (ecmascript)");
var __TURBOPACK__imported__module__$5b$project$5d2f$Backend$2f$newsletter$2f$email$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__ = __turbopack_context__.i("[project]/Backend/newsletter/email.ts [app-route] (ecmascript)");
var __TURBOPACK__imported__module__$5b$project$5d2f$Backend$2f$newsletter$2f$nurture$2d$supabase$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__ = __turbopack_context__.i("[project]/Backend/newsletter/nurture-supabase.ts [app-route] (ecmascript)");
var __TURBOPACK__imported__module__$5b$project$5d2f$Backend$2f$newsletter$2f$nurture$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__ = __turbopack_context__.i("[project]/Backend/newsletter/nurture.ts [app-route] (ecmascript)");
var __TURBOPACK__imported__module__$5b$project$5d2f$Backend$2f$newsletter$2f$unsubscribe$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__ = __turbopack_context__.i("[project]/Backend/newsletter/unsubscribe.ts [app-route] (ecmascript)");
var __TURBOPACK__imported__module__$5b$project$5d2f$Backend$2f$shared$2f$env$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__ = __turbopack_context__.i("[project]/Backend/shared/env.ts [app-route] (ecmascript)");
;
;
...
async function handleNewsletterSubscribe(body) {
    log("── request received ──────────────────────────────");
    const { ok: envOk, missing } = (0, __TURBOPACK__imported__module__$5b$project$5d2f$Backend$2f$shared$2f$env$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["checkEnvPresence"])(REQUIRED_ENV);
    log("env vars present:", Object.fromEntries(REQUIRED_ENV.map((k)=>[
            k,
            !!process.env[k]
        ])));
    if (!envOk) {
        ...
        return {
            ok: false,
            httpStatus: 500,
            error: ("TURBOPACK compile-time truthy", 1) ? msg : "TURBOPACK unreachable"
        };
    }
    const result = (0, __TURBOPACK__imported__module__$5b$project$5d2f$Backend$2f$newsletter$2f$schema$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["validateNewsletterPayload"])(body);
    if (!result.ok) {
    ...
    try {
        ...
        upsert = await (0, __TURBOPACK__imported__module__$5b$project$5d2f$Backend$2f$newsletter$2f$supabase$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["upsertNewsletterSubscriber"])(data);
        ...
        return {
            ok: false,
            httpStatus: 500,
            error: ("TURBOPACK compile-time truthy", 1) ? `Supabase error: ${msg}` : "TURBOPACK unreachable"
        };
    }
    ...
    try {
        ...
        await (0, __TURBOPACK__imported__module__$5b$project$5d2f$Backend$2f$newsletter$2f$email$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["sendChecklistEmail"])(emailAddress, data.locale, unsubscribeToken);
        log("email sent OK");
    } catch (err) {
        const msg = err instanceof Error ? err.message : String(err);
        ...
        return {
            ok: false,
            httpStatus: 500,
            error: ("TURBOPACK compile-time truthy", 1) ? `Email error: ${msg}` : "TURBOPACK unreachable"
        };
    }
    try {
        await (0, __TURBOPACK__imported__module__$5b$project$5d2f$Backend$2f$newsletter$2f$supabase$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["markChecklistSent"])(data.emailNorm);
    ...
    try {
        ...
        await (0, __TURBOPACK__imported__module__$5b$project$5d2f$Backend$2f$newsletter$2f$nurture$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["sendNurtureEmail"])({
            email: emailAddress,
            locale: data.locale,
            step: 1,
            unsubscribeToken
        });
        await (0, __TURBOPACK__imported__module__$5b$project$5d2f$Backend$2f$newsletter$2f$nurture$2d$supabase$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["initNurture"])(data.emailNorm);
...
var __TURBOPACK__imported__module__$5b$project$5d2f$Backend$2f$newsletter$2f$service$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__$3c$locals$3e$__ = __turbopack_context__.i("[project]/Backend/newsletter/service.ts [app-route] (ecmascript) <locals>");
;
;
async function POST(req) {
    ...
    const result = await (0, __TURBOPACK__imported__module__$5b$project$5d2f$Backend$2f$newsletter$2f$service$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__$3c$locals$3e$__["handleNewsletterSubscribe"])(body);
    if (!result.ok) {
        return __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$server$2e$js__$5b$app$2d$route$5d$__$28$ecmascript$29$__["NextResponse"].json({
            error: result.error,
            ...result.field ? {
...
//# sourceMappingURL=%5Broot-of-the-server%5D__1342d650._.js.map