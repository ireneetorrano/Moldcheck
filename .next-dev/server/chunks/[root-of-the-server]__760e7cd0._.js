...
function getChecklistUrl(locale) {
    const base = ("TURBOPACK compile-time value", "http://localhost:3000") ?? "https://www.moldcheck.pt";
...
"[project]/Backend/newsletter/service.ts [app-route] (ecmascript)", ((__turbopack_context__) => {
"use strict";
...
async function handleNewsletterSubscribe(body) {
    ...
    try {
        ...
        await (0, __TURBOPACK__imported__module__$5b$project$5d2f$Backend$2f$newsletter$2f$email$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["sendChecklistEmail"])(data.email, data.locale);
        log("email sent OK");
    } catch (err) {
        const msg = err instanceof Error ? err.message : String(err);
...
var __TURBOPACK__imported__module__$5b$project$5d2f$Backend$2f$newsletter$2f$service$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__ = __turbopack_context__.i("[project]/Backend/newsletter/service.ts [app-route] (ecmascript)");
;
;
async function POST(req) {
    ...
    const result = await (0, __TURBOPACK__imported__module__$5b$project$5d2f$Backend$2f$newsletter$2f$service$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["handleNewsletterSubscribe"])(body);
    if (!result.ok) {
        return __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$server$2e$js__$5b$app$2d$route$5d$__$28$ecmascript$29$__["NextResponse"].json({
            error: result.error,
            ...result.field ? {
...
//# sourceMappingURL=%5Broot-of-the-server%5D__760e7cd0._.js.map