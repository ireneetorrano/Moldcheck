...
const a5MoldRiskContent = {
    ...
    de: {
        ...
        body: [
            ...
            "• Schimmel bedeckt eine Fläche von mehr als 1 m².",
            "• Schimmel kehrt nach der Reinigung an derselben Stelle zurück.",
            "• Anhaltende Gesundheitssymptome, die sich außerhalb der Wohnung verbessern.",
            "• Die Feuchtigkeitsquelle ist nach der Sichtinspektion unklar.",
            "• Versteckter Schimmel wird vermutet (Geruch ohne sichtbare Quelle).",
            "• Die Immobilie ist vermietet und eine Dokumentation wird benötigt.",
