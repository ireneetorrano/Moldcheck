...
"[project]/src/features/tools/lib/calculatorConfig.ts [app-client] (ecmascript)", ((__turbopack_context__) => {
"use strict";
...
"[project]/src/features/tools/lib/scoring.ts [app-client] (ecmascript)", ((__turbopack_context__) => {
"use strict";
...
var __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$features$2f$tools$2f$lib$2f$calculatorConfig$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__ = __turbopack_context__.i("[project]/src/features/tools/lib/calculatorConfig.ts [app-client] (ecmascript)");
;
function computeScore(answers) {
    let total = 0;
    for (const q of __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$features$2f$tools$2f$lib$2f$calculatorConfig$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["QUESTIONS"]){
...
function getBand(score) {
    for (const { band, min } of __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$features$2f$tools$2f$lib$2f$calculatorConfig$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["BAND_THRESHOLDS"]){
...
"[project]/src/config/foundationalArticles.ts [app-client] (ecmascript)", ((__turbopack_context__) => {
"use strict";
...
"[project]/src/features/tools/lib/i18n.ts [app-client] (ecmascript)", ((__turbopack_context__) => {
"use strict";
...
var __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$config$2f$foundationalArticles$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__ = __turbopack_context__.i("[project]/src/config/foundationalArticles.ts [app-client] (ecmascript)");
;
;
function checklistPdf(locale) {
    return "/checklists/moldcheck-checklist-".concat(locale, ".pdf");
}
function inspectionHref(locale) {
    return (0, __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$config$2f$routeMap$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["getLocalizedGlobalPath"])(locale, "services");
}
function healthArticleHref(locale) {
    var _foundationalArticles_find;
    var _foundationalArticles_find_slugs_locale;
    const slug = (_foundationalArticles_find_slugs_locale = (_foundationalArticles_find = __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$config$2f$foundationalArticles$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["foundationalArticles"].find((a)=>a.key === "health")) === null || _foundationalArticles_find === void 0 ? void 0 : _foundationalArticles_find.slugs[locale]) !== null && _foundationalArticles_find_slugs_locale !== void 0 ? _foundationalArticles_find_slugs_locale : "";
    return "/".concat(locale, "/").concat(__TURBOPACK__imported__module__$5b$project$5d2f$src$2f$config$2f$routeMap$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["globalRouteSlugs"].articles[locale], "/").concat(slug);
}
function moldCausesHref(locale) {
    var _foundationalArticles_find;
    var _foundationalArticles_find_slugs_locale;
    const slug = (_foundationalArticles_find_slugs_locale = (_foundationalArticles_find = __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$config$2f$foundationalArticles$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["foundationalArticles"].find((a)=>a.key === "bleach")) === null || _foundationalArticles_find === void 0 ? void 0 : _foundationalArticles_find.slugs[locale]) !== null && _foundationalArticles_find_slugs_locale !== void 0 ? _foundationalArticles_find_slugs_locale : "";
    return "/".concat(locale, "/").concat(__TURBOPACK__imported__module__$5b$project$5d2f$src$2f$config$2f$routeMap$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["globalRouteSlugs"].articles[locale], "/").concat(slug);
}
...
function buildProfileText(locale, answers) {
    var _q_q_buildingType, _q_q_constructionYear, _q_q_location, _q_q_hygrometer, _q_q_moldHistory;
    const q = QUESTION_STRINGS[locale];
    var _q_q_buildingType_options_answers_buildingType;
    const buildingOpt = (_q_q_buildingType_options_answers_buildingType = (_q_q_buildingType = q.q_buildingType) === null || _q_q_buildingType === void 0 ? void 0 : _q_q_buildingType.options[answers.buildingType]) !== null && _q_q_buildingType_options_answers_buildingType !== void 0 ? _q_q_buildingType_options_answers_buildingType : "";
    var _q_q_constructionYear_options_answers_constructionYear;
    const yearOpt = (_q_q_constructionYear_options_answers_constructionYear = (_q_q_constructionYear = q.q_constructionYear) === null || _q_q_constructionYear === void 0 ? void 0 : _q_q_constructionYear.options[answers.constructionYear]) !== null && _q_q_constructionYear_options_answers_constructionYear !== void 0 ? _q_q_constructionYear_options_answers_constructionYear : "";
    var _q_q_location_options_answers_location;
    const locationOpt = (_q_q_location_options_answers_location = (_q_q_location = q.q_location) === null || _q_q_location === void 0 ? void 0 : _q_q_location.options[answers.location]) !== null && _q_q_location_options_answers_location !== void 0 ? _q_q_location_options_answers_location : "";
    var _q_q_hygrometer_options_answers_hygrometer;
    const hygroOpt = (_q_q_hygrometer_options_answers_hygrometer = (_q_q_hygrometer = q.q_hygrometer) === null || _q_q_hygrometer === void 0 ? void 0 : _q_q_hygrometer.options[answers.hygrometer]) !== null && _q_q_hygrometer_options_answers_hygrometer !== void 0 ? _q_q_hygrometer_options_answers_hygrometer : "";
    var _q_q_moldHistory_options_answers_moldHistory;
    const moldOpt = (_q_q_moldHistory_options_answers_moldHistory = (_q_q_moldHistory = q.q_moldHistory) === null || _q_q_moldHistory === void 0 ? void 0 : _q_q_moldHistory.options[answers.moldHistory]) !== null && _q_q_moldHistory_options_answers_moldHistory !== void 0 ? _q_q_moldHistory_options_answers_moldHistory : "";
    const templates = {
        pt: "".concat(buildingOpt, " construído ").concat(yearOpt.toLowerCase(), ", na ").concat(locationOpt).concat(hygroOpt ? ", com humidade ".concat(hygroOpt.toLowerCase()) : "").concat(moldOpt && answers.moldHistory !== "none" ? " e histórico de bolor (".concat(moldOpt.toLowerCase(), ")") : "", " este perfil combina características estruturais com sinais de alerta que merecem atenção."),
        en: "A ".concat(buildingOpt.toLowerCase(), " built ").concat(yearOpt.toLowerCase(), ", in the ").concat(locationOpt).concat(hygroOpt ? ", with humidity ".concat(hygroOpt.toLowerCase()) : "").concat(moldOpt && answers.moldHistory !== "none" ? " and a mold history (".concat(moldOpt.toLowerCase(), ")") : "", " this profile combines structural characteristics with warning signals that deserve attention."),
        fr: "Un ".concat(buildingOpt.toLowerCase(), " construit ").concat(yearOpt.toLowerCase(), ", dans la ").concat(locationOpt).concat(hygroOpt ? ", avec une humidité ".concat(hygroOpt.toLowerCase()) : "").concat(moldOpt && answers.moldHistory !== "none" ? " et un historique de moisissures (".concat(moldOpt.toLowerCase(), ")") : "", " ce profil combine des caractéristiques structurelles avec des signaux d'alerte qui méritent attention."),
        de: "Ein ".concat(buildingOpt.toLowerCase(), ", gebaut ").concat(yearOpt.toLowerCase(), ", in der ").concat(locationOpt).concat(hygroOpt ? ", mit Luftfeuchtigkeit ".concat(hygroOpt.toLowerCase()) : "").concat(moldOpt && answers.moldHistory !== "none" ? " und einer Schimmelgeschichte (".concat(moldOpt.toLowerCase(), ")") : "", " dieses Profil kombiniert strukturelle Merkmale mit Warnsignalen, die Aufmerksamkeit verdienen."),
        nl: "Een ".concat(buildingOpt.toLowerCase(), " gebouwd ").concat(yearOpt.toLowerCase(), ", in de ").concat(locationOpt).concat(hygroOpt ? ", met luchtvochtigheid ".concat(hygroOpt.toLowerCase()) : "").concat(moldOpt && answers.moldHistory !== "none" ? " en een schimmelgeschiedenis (".concat(moldOpt.toLowerCase(), ")") : "", " dit profiel combineert structurele kenmerken met waarschuwingssignalen die aandacht verdienen."),
        it: "Un ".concat(buildingOpt.toLowerCase(), " costruito ").concat(yearOpt.toLowerCase(), ", nella ").concat(locationOpt).concat(hygroOpt ? ", con umidità ".concat(hygroOpt.toLowerCase()) : "").concat(moldOpt && answers.moldHistory !== "none" ? " e una storia di muffa (".concat(moldOpt.toLowerCase(), ")") : "", " questo profilo combina caratteristiche strutturali con segnali di allerta che meritano attenzione."),
        es: "Un ".concat(buildingOpt.toLowerCase(), " construido ").concat(yearOpt.toLowerCase(), ", en la ").concat(locationOpt).concat(hygroOpt ? ", con humedad ".concat(hygroOpt.toLowerCase()) : "").concat(moldOpt && answers.moldHistory !== "none" ? " e historial de moho (".concat(moldOpt.toLowerCase(), ")") : "", " este perfil combina características estructurales con señales de alerta que merecen atención.")
    };
    var _templates_locale;
    return (_templates_locale = templates[locale]) !== null && _templates_locale !== void 0 ? _templates_locale : templates.en;
}
...
"[project]/src/features/tools/lib/analytics.ts [app-client] (ecmascript)", ((__turbopack_context__) => {
"use strict";
...
function plausible() {
    ...
    return (_plausible = window.plausible) !== null && _plausible !== void 0 ? _plausible : null;
}
function track(event, props) {
    try {
        var _plausible;
        (_plausible = plausible()) === null || _plausible === void 0 ? void 0 : _plausible(event, props ? {
            props
        } : undefined);
    } catch (e) {
...
"[project]/src/features/tools/lib/queryString.ts [app-client] (ecmascript)", ((__turbopack_context__) => {
"use strict";
...
function loadFromStorage() {
    try {
        ...
        if ((parsed === null || parsed === void 0 ? void 0 : parsed.answers) && typeof parsed.score === "number") {
            return {
...
"[project]/src/features/tools/components/CalculatorForm.tsx [app-client] (ecmascript)", ((__turbopack_context__) => {
"use strict";
...
function CalculatorForm(param) {
    let { i18n, answers, onChange, onSubmit } = param;
    _s();
    ...
    const firstMissingRef = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useRef"])(null);
    const sections = [
        "building",
        "conditions",
        "lifestyle"
    ];
    const missingIds = __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$features$2f$tools$2f$lib$2f$calculatorConfig$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["QUESTIONS"].filter((q)=>!answers[q.id]).map((q)=>q.id);
    function handleSubmit() {
        if (missingIds.length > 0) {
            setShowValidation(true);
            // Scroll to first unanswered question
            setTimeout(()=>{
                var _firstMissingRef_current;
                (_firstMissingRef_current = firstMissingRef.current) === null || _firstMissingRef_current === void 0 ? void 0 : _firstMissingRef_current.scrollIntoView({
                    behavior: "smooth",
                    block: "center"
                });
            }, 50);
    ...
    return /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
        ...
        children: [
            sections.map((sectionKey)=>{
                const sectionQuestions = __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$features$2f$tools$2f$lib$2f$calculatorConfig$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["QUESTIONS"].filter((q)=>q.sectionKey === sectionKey);
                        ...
                        /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
                            ...
                            children: sectionQuestions.map((q, idx)=>{
                                ...
                                return /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("fieldset", {
                                    className: "calc-question".concat(isMissing ? " calc-question--error" : ""),
                                    ...
                                    children: [
                                        ...
                                        /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
                                            ...
                                            children: q.options.map((opt)=>{
                                                var _qStrings_options_opt_value;
                                                const optLabel = (_qStrings_options_opt_value = qStrings.options[opt.value]) !== null && _qStrings_options_opt_value !== void 0 ? _qStrings_options_opt_value : opt.value;
                                                const isSelected = answers[q.id] === opt.value;
                                                return /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("label", {
                                                    className: "calc-option".concat(isSelected ? " calc-option--selected" : ""),
                                                    children: [
                                        ...
                                        isMissing && /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("p", {
            ...
            showValidation && missingIds.length > 0 && /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
...
_s(CalculatorForm, "IX4bfvFdcOMCAhQ54zrMExPFznA=");
_c = CalculatorForm;
var _c;
...
"[project]/src/features/tools/components/CalculatorResult.tsx [app-client] (ecmascript)", ((__turbopack_context__) => {
"use strict";
...
var __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__ = __turbopack_context__.i("[project]/node_modules/next/dist/compiled/react/jsx-dev-runtime.js [app-client] (ecmascript)");
var __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__ = __turbopack_context__.i("[project]/node_modules/next/dist/compiled/react/index.js [app-client] (ecmascript)");
var __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$features$2f$tools$2f$lib$2f$scoring$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__ = __turbopack_context__.i("[project]/src/features/tools/lib/scoring.ts [app-client] (ecmascript)");
var __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$features$2f$tools$2f$lib$2f$i18n$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__ = __turbopack_context__.i("[project]/src/features/tools/lib/i18n.ts [app-client] (ecmascript)");
var __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$features$2f$tools$2f$lib$2f$queryString$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__ = __turbopack_context__.i("[project]/src/features/tools/lib/queryString.ts [app-client] (ecmascript)");
var __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$features$2f$tools$2f$lib$2f$analytics$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__ = __turbopack_context__.i("[project]/src/features/tools/lib/analytics.ts [app-client] (ecmascript)");
;
var _s = __turbopack_context__.k.signature();
"use client";
;
...
_c = ScoreGauge;
function CalculatorResult(param) {
    let { locale, i18n, answers, score, band, onReset } = param;
    _s();
    const [copied, setCopied] = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useState"])(false);
    const cfg = BAND_CONFIG[band];
    const profileText = (0, __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$features$2f$tools$2f$lib$2f$i18n$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["buildProfileText"])(locale, answers);
    const factorKeys = (0, __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$features$2f$tools$2f$lib$2f$scoring$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["getDetectedRiskFactors"])(answers);
    const checklistIds = (0, __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$features$2f$tools$2f$lib$2f$scoring$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["getPriorityChecklist"])(answers);
    const primaryCta = i18n.ctaPrimary[band];
    const secondaryCta = i18n.ctaSecondary[band];
    function handleShare() {
        const url = (0, __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$features$2f$tools$2f$lib$2f$queryString$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["buildShareUrl"])(answers);
    ...
    function handlePrimaryClick() {
        if (band === "high" || band === "critical") {
            __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$features$2f$tools$2f$lib$2f$analytics$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["analytics"].ctaInspectionClicked();
        } else {
            __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$features$2f$tools$2f$lib$2f$analytics$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["analytics"].ctaChecklistClicked();
        }
    }
    ...
    return /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
        ...
        children: [
            ...
            factorKeys.length > 0 && /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
                className: "calc-result__block",
                children: [
                    /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("h3", {
                        className: "calc-result__block-title",
            ...
            checklistIds.length > 0 && /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
                className: "calc-result__block",
                children: [
                    /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("h3", {
                        className: "calc-result__block-title",
...
_s(CalculatorResult, "NE86rL3vg4NVcTTWDavsT0hUBJs=");
_c1 = CalculatorResult;
var _c, _c1;
__turbopack_context__.k.register(_c, "ScoreGauge");
__turbopack_context__.k.register(_c1, "CalculatorResult");
if (typeof globalThis.$RefreshHelpers$ === 'object' && globalThis.$RefreshHelpers !== null) {
    __turbopack_context__.k.registerExports(__turbopack_context__.m, globalThis.$RefreshHelpers$);
}
}),
"[project]/src/features/tools/components/HumidityCalculator.tsx [app-client] (ecmascript)", ((__turbopack_context__) => {
"use strict";
...
var __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$features$2f$tools$2f$lib$2f$analytics$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__ = __turbopack_context__.i("[project]/src/features/tools/lib/analytics.ts [app-client] (ecmascript)");
var __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$features$2f$tools$2f$lib$2f$queryString$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__ = __turbopack_context__.i("[project]/src/features/tools/lib/queryString.ts [app-client] (ecmascript)");
var __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$features$2f$tools$2f$components$2f$CalculatorForm$2e$tsx__$5b$app$2d$client$5d$__$28$ecmascript$29$__ = __turbopack_context__.i("[project]/src/features/tools/components/CalculatorForm.tsx [app-client] (ecmascript)");
var __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$features$2f$tools$2f$components$2f$CalculatorResult$2e$tsx__$5b$app$2d$client$5d$__$28$ecmascript$29$__ = __turbopack_context__.i("[project]/src/features/tools/components/CalculatorResult.tsx [app-client] (ecmascript)");
;
var _s = __turbopack_context__.k.signature();
"use client";
;
...
function HumidityCalculator(param) {
    let { locale, startDirect } = param;
    _s();
    const i18n = (0, __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$features$2f$tools$2f$lib$2f$i18n$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["getCalcI18n"])(locale);
    const [phase, setPhase] = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useState"])(startDirect ? {
        phase: "form",
        answers: {}
    } : {
        phase: "idle"
    ...
    (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useEffect"])({
        "HumidityCalculator.useEffect": ()=>{
            const fromUrl = (0, __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$features$2f$tools$2f$lib$2f$queryString$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["readAnswersFromUrl"])();
            if (fromUrl) {
                const score = (0, __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$features$2f$tools$2f$lib$2f$scoring$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["computeScore"])(fromUrl);
                const band = (0, __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$features$2f$tools$2f$lib$2f$scoring$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["getBand"])(score);
                setPhase({
                    phase: "result",
                    answers: fromUrl,
                    score,
            ...
            const stored = (0, __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$features$2f$tools$2f$lib$2f$queryString$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["loadFromStorage"])();
            if (stored) {
                const band = (0, __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$features$2f$tools$2f$lib$2f$scoring$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["getBand"])(stored.score);
                setPhase({
                    phase: "result",
    ...
    (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useEffect"])({
        "HumidityCalculator.useEffect": ()=>{
            ...
            const raf = requestAnimationFrame({
                "HumidityCalculator.useEffect.raf": ()=>{
            ...
            return ({
                "HumidityCalculator.useEffect": ()=>cancelAnimationFrame(raf)
            })["HumidityCalculator.useEffect"];
        }
    }["HumidityCalculator.useEffect"], [
        phase.phase
    ...
    function handleStart() {
        __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$features$2f$tools$2f$lib$2f$analytics$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["analytics"].calculatorStarted();
        setPhase({
            phase: "form",
            answers: {}
        });
    ...
    function handleSubmit() {
        if (phase.phase !== "form") return;
        const score = (0, __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$features$2f$tools$2f$lib$2f$scoring$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["computeScore"])(phase.answers);
        const band = (0, __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$features$2f$tools$2f$lib$2f$scoring$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["getBand"])(score);
        __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$features$2f$tools$2f$lib$2f$analytics$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["analytics"].calculatorCompleted(band);
        (0, __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$features$2f$tools$2f$lib$2f$queryString$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["saveToStorage"])(phase.answers, score);
        setPhase({
            phase: "result",
    ...
    const [scrollToTop, setScrollToTop] = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useState"])(false);
    ...
    function handleReset() {
        (0, __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$features$2f$tools$2f$lib$2f$queryString$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["clearStorage"])();
        ...
        children: [
            /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
                ...
                children: [
                    ...
                    phase.phase === "idle" && /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
            ...
            phase.phase === "result" && /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
                ref: resultRef,
                children: /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])(__TURBOPACK__imported__module__$5b$project$5d2f$src$2f$features$2f$tools$2f$components$2f$CalculatorResult$2e$tsx__$5b$app$2d$client$5d$__$28$ecmascript$29$__["CalculatorResult"], {
                    locale: locale,
                    i18n: i18n,
                    answers: phase.answers,
                    score: phase.score,
...
_s(HumidityCalculator, "fBL9AbGHi4SOEywNW0iMQAk49OE=");
_c = HumidityCalculator;
var _c;
__turbopack_context__.k.register(_c, "HumidityCalculator");
if (typeof globalThis.$RefreshHelpers$ === 'object' && globalThis.$RefreshHelpers !== null) {
    __turbopack_context__.k.registerExports(__turbopack_context__.m, globalThis.$RefreshHelpers$);
}
}),
...
//# sourceMappingURL=src_d1cca215._.js.map