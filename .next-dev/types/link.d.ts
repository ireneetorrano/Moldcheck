...
declare namespace __next_route_internal_types__ {
  ...
  type DynamicRoutes<T extends string = string> = 
    ...
    | `/${SafeSlug<T>}/inspection/${SafeSlug<T>}`
    | `/${SafeSlug<T>}/mold-types`
    | `/${SafeSlug<T>}/mold-types/${SafeSlug<T>}`
    | `/${SafeSlug<T>}/municipalities/${SafeSlug<T>}`
    | `/${SafeSlug<T>}/newsletter/unsubscribe`
    | `/${SafeSlug<T>}/portugal`
    | `/${SafeSlug<T>}/privacy`
    | `/${SafeSlug<T>}/remediation`
    | `/${SafeSlug<T>}/remediation/${SafeSlug<T>}`
    | `/${SafeSlug<T>}/search`
    | `/${SafeSlug<T>}/services`
    | `/${SafeSlug<T>}/shop`
    | `/${SafeSlug<T>}/shop/thank-you`
    | `/${SafeSlug<T>}/tools`
