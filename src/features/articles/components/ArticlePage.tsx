...
const a5TocItems: Record<ActiveLocale, TocItem[]> = {
  pt: [
    ...
    { id: "inspeco-diviso-a-diviso",                            label: "Inspecção" },
    { id: "checklist-de-20-pontos",                             label: "Checklist" },
    { id: "o-padro-de-localizao-dizlhe-a-causa",                label: "Tabela" },
  ...
  en: [
    ...
    { id: "roombyroom-inspection",                    label: "Inspection" },
    { id: "how-to-interpret-what-you-found",          label: "Assessment" },
    { id: "location-maps-to-cause",                   label: "Table" },
    { id: "20point-checklist",                        label: "Checklist" },
  ...
  fr: [
    ...
    { id: "ce-dont-vous-avez-besoin-et-ce-que-a-cote",           label: "Ce qu'il faut" },
    { id: "inspection-pice-par-pice",                            label: "Inspection" },
    { id: "comment-interprter-ce-que-vous-avez-trouv",           label: "Interpréter" },
    { id: "la-localisation-indique-la-cause",                    label: "Tableau" },
  ...
  de: [
    ...
    { id: "was-sie-brauchen-und-was-es-kostet",                  label: "Was Sie brauchen" },
    { id: "zimmerfrzimmerinspektion",                            label: "Inspektion" },
    { id: "so-interpretieren-sie-ihre-befunde",                  label: "Befunde" },
    { id: "der-standort-zeigt-die-ursache",                      label: "Tabelle" },
    { id: "20punktecheckliste",                                  label: "Checkliste" },
    { id: "wann-ein-fachmann-gerufen-werden-sollte",             label: "Fachmann" },
    { id: "sources",                                             label: "Quellen" },
    { id: "faq",                                                 label: "FAQ" },
  ],
  nl: [
    ...
    { id: "wat-u-nodig-heeft-en-wat-het-kost",                   label: "Wat u nodig heeft" },
    { id: "kamervoorkamer-inspectie",                            label: "Inspectie" },
    { id: "hoe-u-uw-bevindingen-interpreteert",                  label: "Bevindingen" },
    { id: "de-locatie-wijst-op-de-oorzaak",                      label: "Tabel" },
    { id: "20punten-checklist",                                  label: "Checklist" },
  ...
  it: [
    ...
    { id: "prima-di-iniziare-capire-la-logica",                               label: "La logica" },
    { id: "strumento-fondamentale-ligrometro",                                label: "Igrometro" },
    { id: "segnali-di-allarme-che-la-maggior-parte-delle-persone-ignora",     label: "Segnali" },
    { id: "stanza-per-stanza",                                                label: "Stanza per stanza" },
    { id: "leggere-i-risultati-la-tabella-localizzazione-causa",              label: "Tabella" },
  ...
  es: [
    ...
    { id: "antes-de-empezar-entender-la-lgica",                         label: "La lógica" },
    { id: "herramienta-fundamental-el-higrmetro",                       label: "Higrómetro" },
    { id: "seales-de-advertencia-que-la-mayora-de-las-personas-ignora", label: "Señales" },
    { id: "inspeccin-habitacin-por-habitacin",                          label: "Inspección" },
    { id: "tabla-de-diagnstico-por-localizacin",                        label: "Tabla" },
    { id: "niveles-de-actuacin",                                        label: "Niveles" },
...
const a3TocItems: Record<ActiveLocale, TocItem[]> = {
  ...
  fr: [
    ...
    { id: "les-symptmes-qui-passent-inaperus",                       label: "Symptômes" },
...
const a1TocItems: Record<ActiveLocale, TocItem[]> = {
  pt: [
    { id: "primeiro-problema",                                        label: "Espécies" },
