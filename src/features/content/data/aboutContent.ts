...
const aboutContentByLocale: Record<ActiveLocale, AboutLocaleContent> = {
  ...
  it: {
    ...
    description:
      "MoldCheck.pt esiste per spiegare muffa, umidità e rischi per la qualità dell'aria interna in Portogallo con indipendenza editoriale e base scientifica.",
    introParagraphs: [
